...
import ConfidencialidadBG from "../images/confidencialidad-bg.png";
...
import InmobiliarioImage from "../images/servicios/inmobiliario.svg";
  ...
  <Layout>
      ...
      <Comp.Width75>
        <ServiciosContent>
          <p style={{ color: theme.colors.primaryColor }}>
            ...
            <br />
            <br />
            Si es que usted se puso en contacto con algún miembro del equipo
            Indigo Translations para enfrentar la internacionalización, la
    ...
    <Clientes>
      <Comp.Width75 style={{ paddingBottom: "2rem" }}>
        <p style={{ textAlign: "center", color: theme.colors.primaryColor }}>
          La cartera de clientes de Indigo Translations está formada por
          instituciones financieras, firmas legales internacionales con
          presencia en México, empresas <i>Oil & Gas</i>, entre otros.
        </p>
      </Comp.Width75>
      <Comp.Container>
        <ImageRow>
    ...
    <Confidencialidad mobile>
      <GridContent>
        <Comp.TextCenter style={{ paddingTop: "3rem" }}>
          <Comp.SectionTitleInverse>Confidencialidad</Comp.SectionTitleInverse>
        </Comp.TextCenter>
        <p style={{ color: "#fff" }}>
          ...
          nuestros clientes.
          <br />
          <br /> No dude en contactar a cualquier miembro de nuestro equipo para
    ...
    <Contacto id="contacto">
      <Comp.Row mobile>
        <Comp.Column style={{ flex: "1" }}>
          <GridContent>
            <Comp.SectionTitle>Contacto</Comp.SectionTitle>
            <CorporativosForm />
          </GridContent>
        </Comp.Column>
        <Comp.Column style={{ flex: "1" }}>
...
const IconContainer = styled(CircleImage)`
  width: 8rem;
  height: 8rem;
  border-radius: 8rem;
  margin-right: 0;
...
const ProcessStep = styled(Comp.Column)`
  align-items: center;
  padding: 1rem;
  transition: all 0.33s ease-in-out;
  z-index: 1;
